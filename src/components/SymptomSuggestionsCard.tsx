...
export function SymptomSuggestionsCard({ supplements }: { supplements: Supplement[] }) {
  ...
  return (
    ...
    >
            ...
            >
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    <p style={{ margin: '10px 0 0 0', fontSize: 12, color: 'var(--text-secondary)', lineHeight: 1.65 }}>
                      {s.why}
                    </p>
                    {s.caution && (
                      <p style={{ margin: '6px 0 0 0', fontSize: 11, color: '#e8a87c', lineHeight: 1.5 }}>
                        ⚠️ {s.caution}
                      </p>
                    )}
                  </motion.div>
      ...
      <p style={{ margin: '12px 0 0 0', fontSize: 11, color: 'var(--text-secondary)', lineHeight: 1.5, fontStyle: 'italic' }}>
        Based on your recent check-ins. Not medical advice — talk to your doctor, especially about prescription options like clonidine (sweating/anxiety) or hydroxyzine (sleep/anxiety) which are effective and underused.
      </p>
    </motion.div>
  )
}
